    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 text-sm mt-1">Create your patient portal account</p>
        </div>

        <div className="bg-white rounded-2xl shadow-xl border border-slate-100 p-8">
          <h1 className="text-2xl font-bold text-slate-800 mb-1">Create account</h1>
          <p className="text-slate-500 text-sm mb-6">Join Oglesby Healthcare Consulting</p>
          ...
          <p className="text-center text-sm text-slate-500 mt-4">
            ...
            <Link href="/auth/login" className="text-[#1a3d5c] hover:underline font-medium">
              Sign in
            </Link>
          </p>
        </div>
