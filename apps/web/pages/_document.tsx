    ...
    return (
      <Html
        ...
        <Head>
          ...
          />
          <link rel="apple-touch-icon" sizes="180x180" href="/oglesby-favicon.svg" />
          <link rel="icon" type="image/svg+xml" href="/oglesby-favicon.svg" />
          <link rel="shortcut icon" href="/oglesby-favicon.svg" />
