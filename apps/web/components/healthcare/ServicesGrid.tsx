...
import { Activity, ArrowRight, ShieldCheck, TrendingUp, Video } from "lucide-react";
...
const services = [
  {
    ...
    description:
      "Streamline patient scheduling, reduce wait times, and eliminate bottlenecking in clinical workflows.",
    icon: Activity,
    badge: "Operations",
  ...
  },
  {
    ...
    description:
      "Full HIPAA risk assessments, patient data protocol enforcement, and audit defense preparations.",
    icon: ShieldCheck,
    badge: "Compliance",
  ...
  },
  {
    ...
    description:
      "Integration of HIPAA-compliant video conferencing, online booking widgets, and automated notifications.",
    icon: Video,
    badge: "Telehealth",
  ...
  },
  {
    ...
    description:
      "Optimize medical billing accuracy, reduce claim denials, and accelerate patient reimbursement cycles.",
    icon: TrendingUp,
    badge: "Revenue",
