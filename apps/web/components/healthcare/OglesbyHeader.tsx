    ...
    <header className="sticky top-0 z-50 w-full bg-white/90 backdrop-blur-md border-b border-slate-200">
      <div className="mx-auto flex h-16 w-full max-w-[1600px] items-center justify-between px-6 lg:px-10">
        ...
        <nav className="hidden lg:flex items-center gap-8 h-full">
          <Link
            href="/services"
            className="h-full flex items-center text-sm font-medium text-slate-600 hover:text-cyan-600 border-b-2 border-transparent hover:border-cyan-600 transition-colors">
            Services
          </Link>
          <Link
            href="/consultants"
